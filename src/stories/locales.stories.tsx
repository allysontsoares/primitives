...
import { CalendarContent, FieldRow, Hint, StyleWrapper } from "./story-helpers";
...
export const PortugueseBR: StoryObj = {
	name: "pt-BR (Sunday start)",
	render: () => <LocalePicker locale="pt-BR" label="Data (Português BR)" />,
};
...
export const Arabic: StoryObj = {
	...
	render: () => (
		<StyleWrapper>
			<Hint>
				<code>ar</code> — Arabic locale with right-to-left text. Apply{" "}
				<code>dir="rtl"</code> for full RTL layout.
			</Hint>
			<div dir="rtl">
