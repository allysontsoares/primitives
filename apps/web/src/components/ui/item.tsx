...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "line-clamp-2 text-left text-sm font-normal text-oklch(0.556 0 0) [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-oklch(0.205 0 0) dark:text-oklch(0.708 0 0) dark:[&>a:hover]:text-oklch(0.922 0 0)",
        className
      )}
      {...props}
    />
