...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-xl bg-oklch(1 0 0) px-2.5 py-1.5 text-xs text-oklch(0.145 0 0) shadow-lg ring-1 ring-oklch(0.145 0 0)/5 dark:ring-oklch(0.145 0 0)/10 dark:bg-oklch(0.205 0 0) dark:text-oklch(0.985 0 0) dark:ring-oklch(0.985 0 0)/5 dark:dark:ring-oklch(0.985 0 0)/10",
        className,
      )}
    >
