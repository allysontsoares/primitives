...
function RadioGroupItem({ className, ...props }: RadioPrimitive.Root.Props) {
  return (
    ...
    >
      ...
      >
        <span className="absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-oklch(0.985 0 0) dark:size-2.5 dark:bg-oklch(0.205 0 0)" />
      </RadioPrimitive.Indicator>
    </RadioPrimitive.Root>
  );
}
