...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-8 items-center justify-center border-y border-r border-oklch(0.922 0 0) bg-oklch(0.922 0 0)/50 text-sm transition-[color,box-shadow] duration-200 outline-none first:rounded-l-2xl first:border-l last:rounded-r-2xl aria-invalid:border-oklch(0.577 0.245 27.325) data-[active=true]:z-10 data-[active=true]:border-oklch(0.708 0 0) data-[active=true]:ring-3 data-[active=true]:ring-oklch(0.708 0 0)/30 data-[active=true]:aria-invalid:ring-oklch(0.577 0.245 27.325)/20 dark:data-[active=true]:aria-invalid:ring-oklch(0.577 0.245 27.325)/40 dark:border-oklch(1 0 0 / 15%) dark:bg-oklch(1 0 0 / 15%)/50 dark:aria-invalid:border-oklch(0.704 0.191 22.216) dark:data-[active=true]:border-oklch(0.556 0 0) dark:data-[active=true]:ring-oklch(0.556 0 0)/30 dark:data-[active=true]:aria-invalid:ring-oklch(0.704 0.191 22.216)/20 dark:dark:data-[active=true]:aria-invalid:ring-oklch(0.704 0.191 22.216)/40",
        className,
      )}
      {...props}
    >
