...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-5 overflow-hidden rounded-[min(var(--radius-4xl),24px)] bg-oklch(1 0 0) py-5 text-sm text-oklch(0.145 0 0) shadow-sm ring-1 ring-oklch(0.145 0 0)/5 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 dark:ring-oklch(0.145 0 0)/10 *:[img:first-child]:rounded-t-[min(var(--radius-4xl),24px)] *:[img:last-child]:rounded-b-[min(var(--radius-4xl),24px)] dark:bg-oklch(0.205 0 0) dark:text-oklch(0.985 0 0) dark:ring-oklch(0.985 0 0)/5 dark:dark:ring-oklch(0.985 0 0)/10",
        className,
      )}
      {...props}
    />
