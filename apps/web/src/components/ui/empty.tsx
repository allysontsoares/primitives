  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "flex size-10 shrink-0 items-center justify-center rounded-xl bg-oklch(0.97 0 0) text-oklch(0.145 0 0) [&_svg:not([class*='size-'])]:size-5 dark:bg-oklch(0.269 0 0) dark:text-oklch(0.985 0 0)",
      },
    },
    defaultVariants: {
      variant: "default",
