  ...
  return (
    <>
      ...
      <Callout icon={<InfoIcon />}>
        Kairo has <strong className="font-semibold text-ink">zero CSS</strong>. Nothing renders
        styled out of the box — you attach classes to each part. See the{" "}
        <Link
          href="/styling"
          className="text-ink underline decoration-line-strong underline-offset-[3px] hover:text-accent hover:decoration-accent"
        >
          Styling guide
        </Link>
        .
  ...
  return (
    <>
      ...
      <ul className="prose-docs mb-5">
        <li>
          <strong>Segment order</strong> — <InlineCode>mm/dd/yyyy</InlineCode> vs{" "}
          <InlineCode>dd.mm.yyyy</InlineCode> vs <InlineCode>yyyy/mm/dd</InlineCode>.
        </li>
        <li>
  ...
  const rel = [
    {
      ...
      date: "May 2026",
      tag: "Stable",
      items: ["First stable release.", "React 19 peer dependency.", "RangePicker presets API."],
    },
    {
      v: "0.9.0",
      date: "Apr 2026",
