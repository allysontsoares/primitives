  ...
  return (
    <div
      className={cn(
        ...
        "hover:prose-a:text-orange-600 hover:prose-a:decoration-orange-500 dark:hover:prose-a:text-orange-400",
        "prose-strong:text-zinc-900 dark:prose-strong:text-zinc-100",
        "prose-code:rounded-md prose-code:bg-orange-600/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:font-mono prose-code:text-[0.86em] prose-code:font-medium prose-code:text-orange-700 prose-code:before:content-none prose-code:after:content-none dark:prose-code:bg-orange-400/15 dark:prose-code:text-orange-300",
        className,
      )}
      {...props}
    />
