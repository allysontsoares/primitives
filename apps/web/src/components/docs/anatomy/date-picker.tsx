  ...
  return (
    <AnatomyDiagram>
      ...
      >
        ...
        <rect x={148} y={158} width={480} height={28} fill="var(--anatomy-surface-2)" stroke="var(--anatomy-stroke)" strokeWidth={1.5} rx={3} />
        <text x={158} y={176} fill="var(--anatomy-label)" fontSize={10}>
          DatePicker.Input (segments)
        </text>
        <rect x={648} y={158} width={100} height={28} fill="var(--anatomy-surface-2)" stroke="var(--anatomy-stroke)" strokeWidth={1.5} rx={3} />
